# Programa para encontrar el número mayor de una lista entre 3 y 5 números, el programa evalua el rango de entrada digitado
...
main:
    ...
    # Se inicializa el contador y el valor mayor
    li $t3, 0               # contador de números
    li $t4, -2147483648     # valor inicial del número mayor (mínimo entero)
...
input_loop:
    ...
    li $v0, 5               # syscall para leer un entero
    syscall
    move $t5, $v0           # almacena el número ingresado en $t5
    
    # Comparar si el número ingresado es mayor al actual mayor
    ble $t5, $t4, skip      # si el número ingresado es menor o igual al actual mayor, saltar
    move $t4, $t5           # si es mayor, actualizar el mayor
...
finish:
    # Mostrar el resultado (el número mayor)
    li $v0, 4               # syscall para imprimir
    la $a0, result_msg       # cargar el mensaje de "El número mayor es:"
    syscall
    
    li $v0, 1               # syscall para imprimir entero
    move $a0, $t4           # pasar el mayor encontrado a $a0
    syscall
